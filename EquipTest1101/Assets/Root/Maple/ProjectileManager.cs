...
public class ProjectileManager : MonoBehaviour
{
    ...
    public GameObject Spawn_projDataWarrior(Vector3 _pos, int _index)
    {
    ...
    public GameObject Spawn_playerSwing01(Vector3 _pos)
    {
    ...
    public GameObject Spawn_projDataEnemySkill(Vector3 _pos, int _index)
    {
